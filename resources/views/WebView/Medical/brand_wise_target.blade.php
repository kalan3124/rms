        ...
        <div class="wrapper">
            ...
            <div class="row">
                ...
                <div class="card lighten-2">
                    <div class="">
                        <h5 class="center-align report-header">Target vs Achievementss</h5>
                    </div>
                    <form method="POST" id="form"  style="position: relative" class="card-action">
                        ...
                        <div class="row">
                            ...
                            <input name="date_month" id="date_month"  type="text" class="datepicker">
                            </div>
            ...
            $(document).ready(function(){
                ...
                $('#form').submit(function(e){
                    ...
                    if($date){
                      ...
                      $.ajax({
                        type:'GET',
                        url:'{{ url('/webView/medical') }}/brandWiseTargetSearch',
                        data:{
