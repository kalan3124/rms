...
class RouteWiseTargetVsAchReportController extends ReportController
{
    protected $title = "Route Wise Target vs achievement Report";
    ...
    public function search(Request $request)
    {
        ...
        if (isset($values['route_id'])) {
            $invoice->whereIn('c.route_id', $values['route_id']['value']);
            $return->whereIn('c.route_id', $values['route_id']['value']);
        }
        ...
        if (isset($values['area'])) {
            $invoice->where('ar.ar_id', $values['area']['value']);
            $return->where('ar.ar_id', $values['area']['value']);
        }
        ...
        $count = $this->paginateAndCount($route, $request, $sortBy);
    ...
    {
        $columnController->text('route')->setLabel('Route');
        $columnController->number('target')->setLabel('Target');
        $columnController->number('achi')->setLabel('Achivemant');
    ...
    public function setInputs($inputController)
    {
        ...
        $inputController->setStructure([
            ['user', 'route_id', 'area'], ['chem_id', 's_date'],
        ]);
    }
}
