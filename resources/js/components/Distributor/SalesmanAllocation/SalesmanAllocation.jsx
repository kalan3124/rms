...
import { changeDsrName, changeSrName, changeCheckedDsr, changeCheckedSr, fetchDsr, fetchSr, save, load, clearPage } from "../../../actions/Distributor/SalesmanAllocation";

const mapStateToProps = state => ({
     ...state.SalesmanAllocation
});
...
class SalesmanAllocation extends Component {
          ...
          return (
               <Layout sidebar >
                    <Toolbar variant="dense" className={classes.zIndex}>
                         <Typography variant="h5" >Salesman Distributor Allocation</Typography>
                         ...
                         <Button
                              ...
                              component={Link}
                              to="/sales/other/upload_csv/salesman_distributor"
                         >
                              <CloudUploadIcon />
                              Upload
                         </Button>
...
export default connect(mapStateToProps, mapDispatchToProps)(styler(withRouter(SalesmanAllocation)));
