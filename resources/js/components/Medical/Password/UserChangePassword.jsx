...
import { fetchData, changePassword, updateData,fetchOtherData,changeLockTime,changeAttempts,updateOtherData } from '../../../actions/Medical/UserChangePassword';
...
export const mapDispatchToProps = dispatch => ({
    ...
    onUpdateData: (lock_time,attempts) => dispatch(updateOtherData(lock_time,attempts)),
});
...
class UserChangePassword extends Component {
    ...
    onHandleUpdate() {
        ...
        onUpdateData(lock_time,attempts)
                    ...
                    <Paper className={classes.paper}>
                        <Avatar className={classes.avatar}>
                            <img
                                ...
                                src={APP_URL + "images/user_logo.png"}
                            />
                        </Avatar>
                        <Divider />
                        <Grid container>
                            ...
                            >
                                <TextField
                                    ...
                                    type={"number"}
                                    name=""
                                    label="Lockout Time (Sec)"
                                    value={lock_time ? lock_time : ""}
                                    onChange={this.handleChangeLockTime}
                                />
                            </Grid>
                            <Grid
                                item
                            ...
                            >
                                <TextField
                                    ...
                                    onChange={this.handleChangeLockAttempt}
                                />
                            </Grid>
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withStyles(styles)(withRouter(UserChangePassword)));
