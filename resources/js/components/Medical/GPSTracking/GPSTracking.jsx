...
import {
    ...
    search,
    changeTime
} from "../../../actions/Medical/GPSTracking";
        ...
        return (
            <Layout sidebar>
                ...
                <Paper className={classes.bottomPaper} >
                    <Grid container>
                        <Grid item md={3}>
                            <Vehicle style={{ color: "#ff6161", marginLeft: 155, width: 50, height: 40 }} />
                        ...
                        <Grid item md={3}>
                            <Marker style={{ color: "#36ac5b", marginLeft: 155, width: 50, height: 40 }} />
                        ...
                        <Grid item md={3}>
                            <Marker style={{ color: "#cc1225", marginLeft: 155, width: 50, height: 40 }} />
                        ...
                        <Grid item md={3}>
                            <AccessTimeIcon style={{ color: "#1288cc", marginLeft: 155, width: 50, height: 40 }} />
