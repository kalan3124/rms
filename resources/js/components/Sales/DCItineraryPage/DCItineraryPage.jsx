...
import {
    ...
    submit,
    changeType
} from "../../../actions/Sales/DCItineraryPage";
import { DC_REP_TYPE } from "../../../constants/config";
// import { SALES_REP_TYPE, DISTRIBUTOR_SALES_REP_TYPE, DC_REP_TYPE } from "../../../constants/config";
...
// need to add indexe.js
const mapStateToProps = state => ({
    ...state.DCItineraryPage
});

const mapDispatchToProps = dispatch => ({
    onLoad: (user, year, month) => dispatch(fetchInformations(user, year, month)),
    ...
    onUnselectDayType: (date, dayType) => dispatch(unselectDayType(date, dayType)),
...
class DCItineraryPage extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <Layout sidebar>
                <Toolbar variant="dense">
                    <Typography variant="h5">DC Itinerary</Typography>
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withStyles(styles)( withRouter (DCItineraryPage)));
